...
namespace top {
  ...
  void CalcPartonHistory::FillZPartonHistory(xAOD::PartonHistory* PartonHistory, const std::string& parent, PartonDecorator& dec) {
    ...
    if ( RetrieveParticleInfo(prefix + "_beforeFSR", Z, ZpdgId) ) {
      dec.decorateParticle("MC_Z_beforeFSR" + parentstring, Z, ZpdgId, PartonHistory);
      isonshell = true;
      if ( RetrieveParticleInfo(prefix + "Decay1_beforeFSR", Zdecay1, Zdecay1pdgId) ) {
	dec.decorateParticle("MC_Zdecay1_beforeFSR" + parentstring, Zdecay1, Zdecay1pdgId, PartonHistory);
      }
      if ( RetrieveParticleInfo(prefix + "Decay2_beforeFSR", Zdecay2, Zdecay2pdgId) ) {
	dec.decorateParticle("MC_Zdecay2_beforeFSR" + parentstring, Zdecay2, Zdecay2pdgId, PartonHistory);
      }
    }

    if ( RetrieveParticleInfo(prefix + "_afterFSR", Z, ZpdgId) ) {
      dec.decorateParticle("MC_Z_afterFSR" + parentstring, Z, ZpdgId, PartonHistory);
      isonshell = true;
      if ( RetrieveParticleInfo(prefix + "Decay1_afterFSR", Zdecay1, Zdecay1pdgId) ) {
	dec.decorateParticle("MC_Zdecay1_afterFSR" + parentstring, Zdecay1, Zdecay1pdgId, PartonHistory);
      }
      if ( RetrieveParticleInfo(prefix + "Decay2_afterFSR", Zdecay2, Zdecay2pdgId) ) {
	dec.decorateParticle("MC_Zdecay2_afterFSR" + parentstring, Zdecay2, Zdecay2pdgId, PartonHistory);
      }
    }
    else {
      bool has_Zdecay1_beforeFSR = (RetrieveParticleInfo("MC_l_beforeFSR", Zdecay1, Zdecay1pdgId));
      bool has_Zdecay2_beforeFSR = (RetrieveParticleInfo("MC_lbar_beforeFSR", Zdecay2, Zdecay2pdgId));
	...
	dec.decorateParticle("MC_Z_afterFSR" + parentstring, Z, ZpdgId, PartonHistory);
      ...
      bool has_Zdecay1_afterFSR = (RetrieveParticleInfo("MC_l_afterFSR", Zdecay1, Zdecay1pdgId));
      bool has_Zdecay2_afterFSR = (RetrieveParticleInfo("MC_lbar_afterFSR", Zdecay2, Zdecay2pdgId));
