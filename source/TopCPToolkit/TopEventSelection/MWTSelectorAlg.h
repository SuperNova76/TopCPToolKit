#ifndef EVENT_SELECTOR_MWTSELECTORALG_H
#define EVENT_SELECTOR_MWTSELECTORALG_H
...
namespace top {
  ...
  class MWTSelectorAlg final : public EL::AnaAlgorithm {

    public:
      MWTSelectorAlg(const std::string &name, ISvcLocator *pSvcLocator);
...
#endif // EVENT_SELECTOR_MWTSELECTORALG_H
