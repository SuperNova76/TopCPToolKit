...
namespace top {
  ...
  private:
    ...
    StatusCode add_leptons(ConstDataVector<xAOD::ElectronContainer> &selected_electrons,
                           ConstDataVector<xAOD::MuonContainer> &selected_muons,
                           KLFitter::Particles *myParticles);

    StatusCode add_jets(ConstDataVector<xAOD::JetContainer> &selected_jets,
                        KLFitter::Particles *myParticles);

    StatusCode setJetskLeadingN(ConstDataVector<xAOD::JetContainer> &selected_jets,
    ...
    StatusCode setJetskBtagPriority(ConstDataVector<xAOD::JetContainer> &selected_jets,
