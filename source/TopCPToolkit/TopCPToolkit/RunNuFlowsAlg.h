...
class RunNuFlowsAlg final : public EL::AnaAlgorithm {
   ...
   private:
    ...
    CP::SysReadHandle<xAOD::ElectronContainer> m_electronsHandle{this, "electrons", "", "the electron container to use"};
    CP::SysReadSelectionHandle m_electronSelection{this, "electronSelection", "", "the selection on the input electrons"};
    CP::SysReadHandle<xAOD::MuonContainer> m_muonsHandle{this, "muons", "", "the muon container to use"};
    CP::SysReadSelectionHandle m_muonSelection{this, "muonSelection", "", "the selection on the input muons"};
    CP::SysReadHandle<xAOD::JetContainer> m_jetsHandle{this, "jets", "", "the jet container to use"};
    CP::SysReadSelectionHandle m_jetSelection{this, "jetSelection", "", "the selection on the input jets"};
    CP::SysReadHandle<xAOD::MissingETContainer> m_metHandle{this, "met", "", "the MET container to use"};
    ...
    CP::SysWriteDecorHandle<vector<float>> m_met_input_decor{this, "met_input", "met_input_%SYS%", "The input vector for the met"};
    CP::SysWriteDecorHandle<vector<float>> m_misc_input_decor{this, "misc_input", "misc_input_%SYS%", "The input vector for the misc variables"};
