...
truth_branches = {
    "Ttbar" : [
        ...
        'MC_ttbar_beforeFSR_fromDecay_pt',
        'MC_ttbar_beforeFSR_fromDecay_eta',
        'MC_ttbar_beforeFSR_fromDecay_phi',
        'MC_ttbar_beforeFSR_fromDecay_m',
        'MC_ttbar_afterFSR_fromDecay_pt',
        'MC_ttbar_afterFSR_fromDecay_eta',
        'MC_ttbar_afterFSR_fromDecay_phi',
        'MC_ttbar_afterFSR_fromDecay_m',
